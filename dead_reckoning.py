...
'''
Demonstration of dead-reckoning navigation with v5 motors and Robot Mesh Drivetrain class in C++
To make a copy of this or any public example program so you can edit it, click on the Options gear at the top right. From there, click the Copy Project button, name your copy, and hit OK.
